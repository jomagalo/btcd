...
var MainNetParams = Params{
	...
	// Checkpoints ordered from oldest to newest.
	Checkpoints: []Checkpoint{
		{0, newHashFromStr("00000000c6489d706319a8072155f1ecfc1876e65e62a09c7df2cfccf5d36ef8")},
	...
	// BIP 173.
	Bech32HRPSegwit: "bcp", // always bc for main net

	// Address encoding magics
	PubKeyHashAddrID:        0x08, // starts with 1
	ScriptHashAddrID:        0x12, // starts with 3
	PrivateKeyID:            0x14, // starts with 5 (uncompressed) or K (compressed)
...
var RegressionNetParams = Params{
	...
	// Human-readable part for Bech32 encoded segwit addresses, as defined in
	// BIP 173.
	Bech32HRPSegwit: "bcrt2", // always bcrt for reg test net
...
var TestNet3Params = Params{
	...
	// Human-readable part for Bech32 encoded segwit addresses, as defined in
	// BIP 173.
	Bech32HRPSegwit: "tb2", // always tb for test net
